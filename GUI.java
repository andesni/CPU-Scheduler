...
public class GUI {
    ...
    public GUI() {
        ...
        addBtn.setFont(new Font("Times New Roman", Font.BOLD, 11));
        ...
        removeBtn.setFont(new Font("Times New Roman", Font.BOLD, 11));
        ...
        wtLabel.setFont(new Font("Times New Roman", Font.BOLD, 11));
        wtLabel.setBounds(25, 425, 180, 25);

        tatLabel = new JLabel("Average Turn Around Time:");
        tatLabel.setBounds(25, 450, 180, 25);
        tatLabel.setFont(new Font("Times New Roman", Font.BOLD, 11));
        wtResultLabel = new JLabel();
        wtResultLabel.setFont(new Font("Times New Roman", Font.BOLD, 11));
        wtResultLabel.setBounds(215, 425, 180, 25);
        tatResultLabel = new JLabel();
        tatResultLabel.setFont(new Font("Times New Roman", Font.BOLD, 11));
        tatResultLabel.setBounds(215, 450, 180, 25);

        option = new JComboBox(new String[] { "SRT", "SJF", "RR", "PSN", "PSP", "FCFS" });
        option.setFont(new Font("Times New Roman", Font.BOLD, 11));
        option.setBounds(390, 420, 85, 20);

        computeBtn = new JButton("Compute");
        computeBtn.setBounds(390, 450, 85, 25);
        computeBtn.setFont(new Font("Times New Roman", Font.BOLD, 11));
        ...
        // Unfortunately, Java Swing does not provide a direct way to change the font of
        // the title bar text.
